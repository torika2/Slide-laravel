<section class="container provider-clinics-section m-t-144 kfn_anim k-fadeUp">
    ...
    <div class="tab-section kfn_anim k-fadeUp">
        <div class="tabs flex-box justify-center">
            ...
            <a href="#" class="provider-link btn-white">ინდივიდუალური</a>
            <a href="#" class="provider-link btn-white">კორპორაციული</a>
        </div>
        <div>
                        ...
                        <a href="#" class="swiper-slide">
                            <div class="provider-img-box">
                                <picture>
                                    ...
                                    <img src="{{asset('assets/img/Curatio.png')}}" class="provider-img" alt="">
                                </picture>
                            </div>
                        </a>
                        <a href="#" class="swiper-slide">
                            <div class="provider-img-box">
                                <picture>
                                    <source media="(max-width: 767px)" srcset="{{asset('assets/img/medicor.png')}}">
                                    <source media="(max-width: 1023px)" srcset="{{asset('assets/img/medicor.png')}}">
                                    <img src="{{asset('assets/img/medicor.png')}}" class="provider-img" alt="">
                                </picture>
                            </div>
                        </a>
                        <a href="#" class="swiper-slide">
                            <div class="provider-img-box">
                                <picture>
                                    ...
                                    <img src="{{asset('assets/img/tsh.png')}}" class="provider-img" alt="">
                                </picture>
                            </div>
                        </a>
                        <a href="#" class="swiper-slide">
                            <div class="provider-img-box">
                                <picture>
                                    <source media="(max-width: 767px)" srcset="{{asset('assets/img/enmedic.png')}}">
                                    <source media="(max-width: 1023px)" srcset="{{asset('assets/img/enmedic.png')}}">
                                    <img src="{{asset('assets/img/enmedic.png')}}" class="provider-img" alt="">
                                </picture>
                            </div>
                        </a>
                    </div>
