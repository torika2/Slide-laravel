...
<section class="container-secondary policy-packages">
    <div class="packages-outer">
        ...
        <div class="additional-text noto-semibold">
            <span class="color-prim">ცხელი ხაზის </span>
            საერთაშორისო ნომერი იხილეთ პოლისზე
            ან დარეკეთ საქართველოში ჩვენს ცხელ ხაზზე (+995 32) 2 505 111
        </div>
    </div>
</section>
