...
@section('header')
    <title>{{sitename()}} - {{tr('contact')}} </title>
    <style>
        .error {
            color: #ff095f;
        }
            ...
            <div class="col-xl-12">
                ...
                @can('updateStaticData')
                    <div id="panel-static" class="panel">
                        ...
                        <div class="panel-hdr">
                            <h2>
                                {{tr('contact')}} <span class="fw-300"><i>{{tr('static data')}}</i></span>
                            </h2>
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-hdr">
                        <h2>
                            {{tr('contact')}} <span class="fw-300"><i>{{tr('list')}}</i></span>
                        </h2>
                        <div class="panel-toolbar">
                            <button class="btn btn-panel" data-action="panel-collapse" data-toggle="tooltip"
                                    data-offset="0,10" data-original-title="{{tr('collapse')}}"></button>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="col-sm-12 d-flex align-items-center justify-content-end">
                                <a href="{{route('CMS.contact.create')}}" class="btn btn-primary waves-effect waves-themed ">
                                    {{tr('add new')}}</a>
                            </div>
                            <br/>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table =  $('#data_table').DataTable({
                ...
                ajax: {
                    url: "{{route('CMS.contact.list')}}",
                    type: 'GET',
                },
                columns: [
                    {data: 'ord', name: 'ord'},
                    {data: 'department.{{App::getLocale()}}', name: 'department'},
