...
<section class="head-banner policy-medi kfn_anim k-fadeUp active-kfn">
    <div class="img-box imgg">
        <picture>
            ...
            <img src="http://gpi.test/assets/img/medi.jpg" class="img-absolute" alt="" style="transform: translateY(156.505px);">
        </picture>
        <div class="img-overlay"></div>
    </div>
    <div class="container-secondary banner-content flex-box column">
        <nav class="banner-links flex-box al-center" style="display: none">
