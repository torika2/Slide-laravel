...
@section('pageName')faqInner @endsection
@section('content')
...
<section class="container-secondary policy-packages kfn_anim k-fadeUp">
    <div class="packages-outer faq-outer">
        <div class="faq-categories flex-box">
            <div class="faq-links">
                <h2 class="faq-title font-34 fira-bold">კატეგორიები</h2>
                <div class="faq-subtitle font-21">აირჩიე კატეგორია</div>
                <ol class="swiper-container faq-list">
                    <div class="swiper-wrapper">
                        <li class="swiper-slide active">
                            <a href="#" class="noto-bold">ჯანმრთელობა</a>
                        </li>
                        <li class="swiper-slide">
                            <a href="#" class="noto-bold">სამოგზაურო დაზღვევა</a>
                        </li>
                        <li class="swiper-slide">
                            <a href="#" class="noto-bold">როგორ ავანაზღაურო</a>
                        </li>
                        <li class="swiper-slide">
                            <a href="#" class="noto-bold">მანქანის დაზღვევა</a>
                        </li>
                        <li class="swiper-slide">
                            <a href="#" class="noto-bold">ბინის დაზღვევა</a>
                        </li>
                        <li class="swiper-slide">
                            <a href="#" class="noto-bold">ბიზნეს დაზღვევა</a>
                        </li>
                        <li class="swiper-slide">
                            <a href="#" class="noto-bold">სხვისი დაზღვევა</a>
                        </li>
                        <li class="swiper-slide">
                            <a href="#" class="noto-bold">როგორ ავანაზღაურო</a>
                        </li>
            ...
            <div class="service-content">
                <div class="service-box">
                    ...
                    <div class="service-description text">შემთხვევითად გენერირებული ტექსტი
                        ეხმარება
                        დიზაინერებს და
