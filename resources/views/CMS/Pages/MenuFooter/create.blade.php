        ...
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-hdr">
                        <h2>
                            {{tr('menu')}} <span class="fw-300"><i></i></span>
                        </h2>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form method="post" id="form" action="{{route('CMS.footerMenu.store',[$columnId])}}" enctype="multipart/form-data">
                                {{csrf_field()}}
                                @if($data)
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <a href="{{route('CMS.footerMenu.list',[$columnId])}}"
