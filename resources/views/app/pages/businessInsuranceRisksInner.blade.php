...
@section('content')
    ...
    <section class="businessInner directHeadContainer">
        <div class="businessGalleryInner directHeadInner">
            <h3 class="font-34 fira-bold">ავტო</h3>
            <div class="busTabs">
                <div class="busTab noto-semibold" data-index="0">ქურდობა</div>
                <div class="busTab noto-semibold" data-index="1">ძარცვა</div>
                <div class="busTab noto-semibold" data-index="2">ყაჩაღობა</div>
                <div class="busTab noto-semibold active" data-index="3">მესამე პირის მიერ მიყენებული ზიანი</div>
                <div class="busTab noto-semibold" data-index="4">ხანძარი</div>
            </div>
            <div class="directInnerLinksContainer">

                <div class="directInnerLinkFooter">
                    <div class="directInnerTabListContainer animate">
                        <div class="directInnerTabListInner">
                            <div class="directInnerTabList active" data-index="0">
                                <h4 class="noto-bold">იმოქმედე, ჩვენ დაგაზღვევთ!</h4>
                                <div class="txt text">
                                    თუ კომპანიას ყავს ავტომობილ(ებ)ი გახსოვდეთ რო დაუზღვევლობის შემთხვევაში სრული ფინანსური ზარალი კომპანიის ასანაზღაურებელია, თუმცა არსებობს არჩევანი.
                                    როცა დაზღვეულია სატრანსპორტო საშუალებები, თავიდან იცილებთ თქვენი თანამშრომლის ან მესამე პირის ბრალეულობით დამდგარ ფინანსურ ზარალს.
                                </div>
                            </div>
                            <div class="directInnerTabList" data-index="1">
                                <h4 class="noto-bold">იმოქმედე, ჩვენ დაგაზღვევთ!</h4>
                                <div class="txt text">
                                    თუ კომპანიას ყავს ავტომობილ(ებ)ი გახსოვდეთ რო დაუზღვევლობის შემთხვევაში სრული ფინანსური ზარალი კომპანიის ასანაზღაურებელია, თუმცა არსებობს არჩევანი.
                                    როცა დაზღვეულია სატრანსპორტო საშუალებები, თავიდან იცილებთ თქვენი თანამშრომლის ან მესამე პირის ბრალეულობით დამდგარ ფინანსურ ზარალს.
                            ...
                            <div class="directInnerTabList"  data-index="2">
                                <h4 class="noto-bold">იმოქმედე, ჩვენ დაგაზღვევთ!</h4>
                                <div class="txt text">
                                    თუ კომპანიას ყავს ავტომობილ(ებ)ი გახსოვდეთ რო დაუზღვევლობის შემთხვევაში სრული ფინანსური ზარალი კომპანიის ასანაზღაურებელია, თუმცა არსებობს არჩევანი.
                                    როცა დაზღვეულია სატრანსპორტო საშუალებები, თავიდან იცილებთ თქვენი თანამშრომლის ან მესამე პირის ბრალეულობით დამდგარ ფინანსურ ზარალს.
                            ...
                            <div class="directInnerTabList"  data-index="3">
                                <h4 class="noto-bold">იმოქმედე, ჩვენ დაგაზღვევთ!</h4>
                                <div class="txt text">
                                    თუ კომპანიას ყავს ავტომობილ(ებ)ი გახსოვდეთ რო დაუზღვევლობის შემთხვევაში სრული ფინანსური ზარალი კომპანიის ასანაზღაურებელია, თუმცა არსებობს არჩევანი.
                                    როცა დაზღვეულია სატრანსპორტო საშუალებები, თავიდან იცილებთ თქვენი თანამშრომლის ან მესამე პირის ბრალეულობით დამდგარ ფინანსურ ზარალს.
                            ...
                            <div class="directInnerTabList"  data-index="4">
                                <h4 class="noto-bold">იმოქმედე, ჩვენ დაგაზღვევთ!</h4>
                                <div class="txt text">
                                    თუ კომპანიას ყავს ავტომობილ(ებ)ი გახსოვდეთ რო დაუზღვევლობის შემთხვევაში სრული ფინანსური ზარალი კომპანიის ასანაზღაურებელია, თუმცა არსებობს არჩევანი.
                                    თუ კომპანიას ყავს ავტომობილ(ებ)ი გახსოვდეთ რო დაუზღვევლობის შემთხვევაში სრული ფინანსური ზარალი კომპანიის ასანაზღაურებელია, თუმცა არსებობს არჩევანი.
