    ...
    <div class="tab-section  kfn_anim k-fadeUp">
        <div class="services-tabs insurance-tabs flex-box al-center">
            ...
            <div class="tab-link flex-box al-center justify-center noto-bold current" data-tab="tab-1">
                სავალდებულო</div>
            <div class="tab-link flex-box al-center justify-center noto-bold" id="tabCorporate" data-tab="tab-2">
                საჭირო
            </div>
        </div>
        <div>
                ...
                <div class="swiper-container provider-clinics-slider individual">
                    <div class="swiper-wrapper">
                        <a href="#" class="swiper-slide">
                            <div class="slide-content flex-box column al-center">
                                <div class="provider-img-box">
                                    <img src="{{asset('assets/img/health-icon.svg')}}" alt="">
                                </div>
                                <div class="slide-text noto-bold font-21 text-center">თანამშრომლების
